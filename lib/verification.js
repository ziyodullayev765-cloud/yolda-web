 ...
 *   LICENSE   — haydovchilik guvohnomasi. Xuddi shu tartibda.
...
export const KINDS = ['PHONE', 'IDENTITY', 'LICENSE', 'TRANSPORT'];

/** Odam ko'rib chiqadigan turlar — qolgani avtomatik. */
export const REVIEWED_KINDS = ['IDENTITY', 'LICENSE', 'TRANSPORT'];
