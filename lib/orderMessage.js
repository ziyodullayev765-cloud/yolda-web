...
export const buildOrderHeader = (order) => {
  ...
  return [
    ...
    '',
    `👤 ${escapeMd(order.name)}`,
    // Elektron pochta manzili guruhga chiqmaydi. Bu xabar YO'LDA
    // haydovchilar guruhiga boradi — u yerdagi hamma o'qiydi, ishonch
    // belgisi uchun esa "Google orqali kirgan" degani yetarli.
    // Manzilning o'zi hech kimga kerak emas, tarqalishi esa zarar.
    order.googleEmail ? '✅ Google orqali kirgan' : null,
